...
STACKFILES = [
    '/content/data/stackoverflow/stackoverflow-top50k.csv',
    '/content/data/stackoverflow/stackoverflow-score81-47-50k.csv',
    '/content/data/stackoverflow/stackoverflow-score46-33-50k.csv',
...
def ds_stack(stackfiles: List[str] = STACKFILES, text_cols: List[str] = [], name_text_col: str = 'description',
    ...
    dfc = tags_all[0].value_counts()[:500]
